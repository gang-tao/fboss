...
struct SaiSwitchTraits {
  ...
  struct Attributes {
    ...
    using SyncLock =
        SaiExtensionAttribute<sai_pointer_t, AttributeSyncLockWrapper, SaiPointerDefault>;

    struct AttributeSyncUnlockWrapper {
      std::optional<sai_attr_id_t> operator()();
    };
    using SyncUnlock =
        SaiExtensionAttribute<sai_pointer_t, AttributeSyncUnlockWrapper, SaiPointerDefault>;
#endif
  };
